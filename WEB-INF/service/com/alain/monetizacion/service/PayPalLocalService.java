...
/**
 * Provides the local service interface for PayPal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alain
 * @see PayPalLocalServiceUtil
...
public interface PayPalLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PayPalLocalServiceUtil} to access the pay pal local service. Add custom service methods to {@link com.alain.monetizacion.service.impl.PayPalLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
