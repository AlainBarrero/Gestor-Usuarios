...
/**
 * The persistence utility for the pay pal service. This utility wraps {@link PayPalPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PayPalUtil {
	 ...
	 */
	public static void clearCache(PayPal payPal) {
		getPersistence().clearCache(payPal);
	}
	 ...
	 */
	public static List<PayPal> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static PayPal update(PayPal payPal) throws SystemException {
		return getPersistence().update(payPal);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static PayPal update(PayPal payPal, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(payPal, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.alain.monetizacion.model.PayPal payPal) {
		getPersistence().cacheResult(payPal);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(payPals);
	}
	...
	*/
	public static com.alain.monetizacion.model.PayPal create(
	...
	*/
	public static com.alain.monetizacion.model.PayPal remove(
		long configurationId)
	...
	public static com.alain.monetizacion.model.PayPal updateImpl(
		com.alain.monetizacion.model.PayPal payPal)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(payPal);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.alain.monetizacion.model.PayPal findByPrimaryKey(
		long configurationId)
		throws com.alain.monetizacion.NoSuchPayPalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.alain.monetizacion.model.PayPal fetchByPrimaryKey(
		long configurationId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.alain.monetizacion.model.PayPal> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static PayPalPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (PayPalPersistence)PortletBeanLocatorUtil.locate(com.alain.monetizacion.service.ClpSerializer.getServletContextName(),
					PayPalPersistence.class.getName());

			ReferenceRegistry.registerReference(PayPalUtil.class, "_persistence");
		}
	 ...
	 */
	public void setPersistence(PayPalPersistence persistence) {
	}

	private static PayPalPersistence _persistence;
}