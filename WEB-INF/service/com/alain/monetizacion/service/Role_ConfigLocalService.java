...
/**
 * Provides the local service interface for Role_Config. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alain
 * @see Role_ConfigLocalServiceUtil
...
public interface Role_ConfigLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Role_ConfigLocalServiceUtil} to access the role_ config local service. Add custom service methods to {@link com.alain.monetizacion.service.impl.Role_ConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
