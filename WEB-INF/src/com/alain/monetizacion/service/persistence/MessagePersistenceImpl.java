...
import com.alain.monetizacion.NoSuchMessageException;
import com.alain.monetizacion.model.Message;
import com.alain.monetizacion.model.impl.MessageImpl;
import com.alain.monetizacion.model.impl.MessageModelImpl;
...
public class MessagePersistenceImpl extends BasePersistenceImpl<Message>
	 ...
	 * @throws com.alain.monetizacion.NoSuchMessageException if a matching message could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	 ...
	 * @throws com.alain.monetizacion.NoSuchMessageException if a message with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(MessageModelImpl.ENTITY_CACHE_ENABLED,
			MessageModelImpl.FINDER_CACHE_ENABLED, MessageImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID =
		new FinderPath(MessageModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			MessageModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(MessageModelImpl.ENTITY_CACHE_ENABLED,
			MessageModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByuserId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the messages where userId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<Message> findByuserId(long userId) throws SystemException {
		return findByuserId(userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the messages where userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.alain.monetizacion.model.impl.MessageModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Message> findByuserId(long userId, int start, int end)
		throws SystemException {
		return findByuserId(userId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the messages where userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.alain.monetizacion.model.impl.MessageModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first message in the ordered set where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching message
	 ...
	 */
	@Override
	public Message findByuserId_First(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchMessageException, SystemException {
		Message message = fetchByuserId_First(userId, orderByComparator);
	 ...
	 */
	@Override
	public Message fetchByuserId_First(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Message> list = findByuserId(userId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last message in the ordered set where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching message
	 ...
	 */
	@Override
	public Message findByuserId_Last(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchMessageException, SystemException {
		Message message = fetchByuserId_Last(userId, orderByComparator);
	 ...
	 */
	@Override
	public Message fetchByuserId_Last(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Message> list = findByuserId(userId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the messages before and after the current message in the ordered set where userId = &#63;.
	 *
	 * @param messageId the primary key of the current message
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Message[] findByuserId_PrevAndNext(long messageId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchMessageException, SystemException {
		Message message = findByPrimaryKey(messageId);
		...
		try {
			...
			array[0] = getByuserId_PrevAndNext(session, message, userId,
					orderByComparator, true);

			array[1] = message;

			array[2] = getByuserId_PrevAndNext(session, message, userId,
					orderByComparator, false);
	...
	protected Message getByuserId_PrevAndNext(Session session, Message message,
	...
	/**
	 * Removes all the messages where userId = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByuserId(long userId) throws SystemException {
		for (Message message : findByuserId(userId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(message);
		}
	}
	...
	/**
	 * Returns the number of messages where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @return the number of matching messages
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "message.userId = ?";
	...
	@Override
	public Message updateImpl(com.alain.monetizacion.model.Message message)
		throws SystemException {
		message = toUnwrappedModel(message);
		...
		if (isNew || !MessageModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((messageModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						messageModelImpl.getOriginalUserId()
					};
				...
				args = new Object[] { messageModelImpl.getUserId() };
	...
	protected Message toUnwrappedModel(Message message) {
		...
		messageImpl.setDescription(message.getDescription());
		messageImpl.setIsValidate(message.isIsValidate());
	...
	/**
	 * Returns the message with the primary key or throws a {@link com.alain.monetizacion.NoSuchMessageException} if it could not be found.
	 *
	 * @param messageId the primary key of the message
	 * @return the message
	 * @throws com.alain.monetizacion.NoSuchMessageException if a message with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.alain.monetizacion.model.Message")));
